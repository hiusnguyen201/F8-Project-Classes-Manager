...
const { messageSuccess } = require("../../../constants/constants.message");
...
module.exports = {
  settings: async (req, res) => {
    ...
    return res.render(renderPath.HOME_SETTING, {
  ...
  handleUpdateProfile: async (req, res) => {
    ...
    req.flash("success", messageSuccess.UPDATED_PROFILE);
    return res.redirect(redirectPath.SETTINGS_PROFILE_ADMIN);
  },
  ...
  handleRemoveUserSocial: async (req, res) => {
    ...
    req.flash("success", messageSuccess.REMOVE_ACCOUNT_SOCIAL_SUCCESS);
